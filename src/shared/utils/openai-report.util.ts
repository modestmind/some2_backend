...
[중요] 각 섹션 내용을 작성할때 중요한 단어나 문장에 밑줄, 폰트색상, 텍스트배경색, 박스영역 등 스타일을 적용해 주고, p태그로 단락 구분하는 등 웹페이지에서 최대한 보기 좋게 만들어줘. html 태그나 인라인 css를 적용해서 각 섹션의 내용을 html로 만들어줘. 단 폰트 크기는 설정하지 말아줘.
`;
